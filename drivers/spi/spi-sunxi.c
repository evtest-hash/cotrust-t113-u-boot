...
static void sun4i_spi_set_speed_mode(struct udevice *dev)
{
	...
	//writel(T113_CCU_BASE + CCU_SPI0_CLK_REG, ((1U << 31) | (0x1 << 24) | (0 << 8) | 2));
	//printf("CCU_SPI0_CLK_REG=%x\n",readl(0x2001940));
	//writel(0x2001940, 0x81000002);
	//printf("CCU_SPI0_CLK_REG=%x\n",readl(0x2001940));
	/*
	 * Setup clock divider.
	 *
...
static int sun4i_spi_probe(struct udevice *bus)
{
	...
	run_command("mw.l 0x2001940 0x81000002",0);
	//writel(T113_CCU_BASE + CCU_SPI0_CLK_REG, ((1U << 31) | (0x1 << 24) | (0 << 8) | 2));
...
static const struct sun4i_spi_variant sun8i_t113_spi_variant = {
	.regs			= sun6i_spi_regs,
	.bits			= sun6i_spi_bits,
	.fifo_depth		= 64,
	.has_soft_reset		= true,
...
static const struct udevice_id sun4i_spi_ids[] = {
	...
	},
	{
	  ...
	  .data = (ulong)&sun8i_t113_spi_variant,
	},
	{ /* sentinel */ }
};
