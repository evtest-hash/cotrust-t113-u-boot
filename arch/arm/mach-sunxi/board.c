...
static int gpio_init(void)
{
	...
	sunxi_gpio_set_cfgpin(SUNXI_GPF(2), 3);
	sunxi_gpio_set_cfgpin(SUNXI_GPF(4), 3);
	sunxi_gpio_set_pull(SUNXI_GPF(4), SUNXI_GPIO_PULL_UP);
#else
...
#endif
#elif CONFIG_CONS_INDEX == 3 && defined(CONFIG_MACH_SUN8I_T113)
	sunxi_gpio_set_cfgpin(SUNXI_GPG(8), 5);
	sunxi_gpio_set_cfgpin(SUNXI_GPG(9), 5);
	sunxi_gpio_set_pull(SUNXI_GPG(9), SUNXI_GPIO_PULL_UP);
